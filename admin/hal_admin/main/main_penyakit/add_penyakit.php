...
//$dataKode	= buatKode("penyakit", "H"); Jika ingin kode otomatis aktifkan ini dan nonaktifkan dataKode dibawah
...
<table width="100%" cellpadding="2" cellspacing="1" class="table-list">
	...
	<tr>
	  ...
	  <!--<td width="84%"><input name="textKode" value="<?php echo $dataKode; ?>" size="10" maxlength="4" readonly="readonly"/></td></tr> Jika ingin kode otomatis aktifkan ini dan nonaktifkan dataKode dibawah-->
