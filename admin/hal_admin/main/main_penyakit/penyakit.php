...
echo "
<div class=judul><h2>Daftar Penyakit</h2></div>
<br/>
<form action='' method='post'>
<div style='float:right; padding:10px; width:300px; margin-top:5px;'>
<a class='thickbox' href='main/main_penyakit/add_penyakit.php'>Tambah Penyakit</a>
...
<table id=o width=100%><tbody>
    ...
    while ($r=mysql_fetch_array($tampil)){
       ...
       echo "<tr bgcolor=" . $bg . ">
			 ...
			 <td class=td>$r[np_populasi]</td>
			 <td><div align='center' style='background-color:none;'><a class='colorbox' href=main/main_penyakit/edit_penyakit.php?Kode=" . $r['kd_penyakit'] . " ><img src='../images/edit.png' border='0' width='16' height='16' /></a></div></td>
