...
if (isset($_POST['Del'])) {
    ...
    echo "
<body>
<div class='judul'><h2>DAFTAR PESAN KONTAK</h2></div>
<br/>
...
<table width='100%' border='0' align='center' style='margin-bottom:10px;'>
  <tr>
    ...
    <th><div align='center' class='style1'>Nama</div></th>
	<th><div align='center' class='style1'>Email</div></th>
    <th><div align='center' class='style1'>Tanggal</div></th> 
	<th><div align='center' class='style1'>Status</div></th> 
    <th><div align='center'><span class='style1'>Lihat</span></div></th>
