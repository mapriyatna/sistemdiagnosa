...
$('#ajax_loading').hide();  
 ...
 var login_response = '<div id="logged_in"><br /><br />' +
	 ...
	 '</div>' +
	 '<div style="margin: 10px 0px 0px 10px; float: right; width: 300px; color:#333333; font-size:15px;">'+ 
	 "Anda Telah berhasil Login <br /> Mohon tunggu beberapa detik<br /><br /><br /><br /></div></div>";  
