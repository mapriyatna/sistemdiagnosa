...
$sql = "SELECT diagnosa.*, pasien.* , penyakit.*, tbsolusi.* 
		FROM diagnosa,pasien,penyakit,tbsolusi 
		WHERE pasien.idpasien=diagnosa.idpasien
		AND diagnosa.idpasien='$NOIP' AND diagnosa.id_penyakit=penyakit.id_penyakit
...
<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#DBEAF5">
  <tr align="center" bgcolor="#336699"> 
    <td height="35" colspan="2" align="left" valign="top"><div align="center">
      <h3 class="style1">Laporan Hasil Dianogsa Penyakit</h3>
    </div></td>
  </tr>
  <tr> 
